...
import img from '../../img/beagle.svg'
        ...
        <Container className={styles.container}>
            ...
            <Row className='justify-content-md-center'>
                <Col md={8} lg={6}>
                    ...
                    <Card.Body>
                        <img src={img} className={styles.img} alt='beagle' />
                    </Card.Body>
                    </Card>
                </Col>
            </Row>
                ...
                <Col md={8} lg={6}>
                    ...
                    <motion.div
                        ...
                        transition={{ 
                            delay: .3 }}
                    >
                        <Card.Title className={styles.title}>아이디어가 많은 비글</Card.Title>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                ...
                <Col md={8} lg={6}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            ...
                            <span className={styles.worstText}>마스티프</span>
                        </Card.Text>
                    </Card.Body>
                    </Card>
                </Col>
