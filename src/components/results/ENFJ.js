...
import img from '../../img/retriever.svg'
        ...
        <Container className={styles.container}>
            ...
            <Row className='justify-content-md-center'>
                <Col md={8} lg={6}>
                    ...
                    <Card.Body>
                        <img src={img} className={styles.img} alt='retriever' onLoad={()=>{
                ...
                <Col md={8} lg={6}>
                    ...
                    <motion.div
                        ...
                        transition={{ 
                            delay: .3 }}
                    >
                        <Card.Title className={styles.title}>협동적인 골든 리트리버</Card.Title>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ 
                            delay: .4 }}
                    >
                        <Card.Text className={styles.text}>따뜻하고 적극적이며 책임감이 강하고 사교성이 풍부하고 동정심이 많아요. 사람들의 생각이나 의견에 진지한 관심을 가지고 공동선을 위해 다른 사람의 의견에 대체로 동의해요.
                        </Card.Text>
                    </motion.div>
                    </Card.Body>
                    </Card>
            ...
            <Row className='justify-content-md-center'>
                <Col md={8} lg={6}>
                    ...
                    <Card.Body className={styles.tagWrapper}>
                        ...
                        <span className={styles.tag}>책임감이 강함</span>
                        <span className={styles.tag}>사교성 풍부</span>
                        <span className={styles.tag}>동정심</span>
                        <span className={styles.tag}>이타적임</span>
                        <span className={styles.tag}>부드러움</span>
                        <span className={styles.tag}>적극적</span>
                        <span className={styles.tag}>참을성이 좋음</span>
                    </Card.Body>
                    </Card>
                </Col>
            </Row>
            ...
            <Row className='justify-content-md-center'>
                <Col md={8} lg={6}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            <span className={styles.bestText}>세인트 버나드</span>
