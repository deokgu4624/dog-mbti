                ...
                <Col md={8} lg={6}>
                    ...
                    <motion.div
                        ...
                        transition={{ 
                            delay: .3 }}
                    >
                        <Card.Title className={styles.title}>친선도모, 달마시안</Card.Title>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ 
                            delay: .4 }}
                    >
                        <Card.Text className={styles.text}>동정심이 많고 다른 사람에게 관심을 쏟으며 인화를 중시해요. 타고난 협력자로서 동료애가 많고 친절하며 능동적인 타입이에요.
                        </Card.Text>
                    </motion.div>
                    </Card.Body>
                    </Card>
            ...
            <Row className='justify-content-md-center'>
                <Col md={8} lg={6}>
                    ...
                    <Card.Body className={styles.tagWrapper}>
                        <span className={styles.tag}>인내심</span>
                        <span className={styles.tag}>조화와 균형</span>
                        <span className={styles.tag}>동정심</span>
                        <span className={styles.tag}>친절</span>
                        <span className={styles.tag}>헌신</span>
                        <span className={styles.tag}>높은 자존감</span>
                        <span className={styles.tag}>긍정적</span>
                ...
                <Col md={8} lg={6}>
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            ...
                            <span className={styles.worstText}>보더콜리</span>
                        </Card.Text>
                    </Card.Body>
                    </Card>
                </Col>
